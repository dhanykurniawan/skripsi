...
<body>
  ...
  <div class="container">
    ...
    <div class="tambah">
      <h3>Form Bahan Baku (Masuk)</h3>
      <form action="bahan_masuk_aksi.php" method="post" enctype="multipart/form-data">
        <table class="tambahdata">
          ...
          <tr>
            <td class="labeldata">Supplier</td>
            <td class="isiandata">
          ...
          <tr>
            <td class="labeldata">Jumlah Tambah Stock</td>
            <td class="isiandata">
              <input type="text" name="jml_tambah" placeholder="Jumlah tambah stock" required>
            </td>
          </tr>
          <tr>
            <td class="labeldata">Bukti Transaksi</td>
            <td class="isiandata">
    ...
    <div class="data">
      <h3>History Bahan Baku Masuk</h3>
      <table class="history masuk">
        <tr class="baris1">
        ...
        <?php
        $data = mysqli_query($koneksidb, "SELECT * FROM masuk WHERE status!=1");
        ...
        ?>
          ...
          <tr class="data">
            ...
            <td class="kolomhistory5"><?= $keterangan; ?></td>
            <td class="kolomhistory6"><?= $bukti_transaksi; ?></td>
            <td class="kolomhistory7">
              <a href="edit_masuk.php?id=<?= $d['id_masuk']; ?>" class="tombol editdata">EDIT</a>
              <!-- <a href="hapusmasuk.php?id=<?= $d['id_masuk']; ?>" class="tombol hapusdata" onclick="return confirm('APAKAH ANDA YAKIN INGIN MENGHAPUS DATA INI?')">HAPUS</a></td> -->
      ...
      <i><b><u>N O T E:</u></b></i>
      <br>
      <i>1. Data yang ditampilkan hanyalah data bahan masuk yang <b><u>BELUM DIPERIKSA</u></b> dan <b><u>DITOLAK</u></b>.</i>
      <br>
      <i>2. Jika data yang telah/pernah anda inputkan tidak tampil pada tabel diatas, maka berarti data tersebut telah diperiksa dan <b><u>TELAH DITERIMA</b></u> oleh pihak Toko Mato Aia Perabot.</i>
    </div>
