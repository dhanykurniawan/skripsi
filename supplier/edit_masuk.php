  ...
  <div class="container">
    ...
    ?>
      ...
      <div class="tambah">
        ...
        <form action="edit_masuk_aksi.php?id=<?= $id; ?>" method="post" enctype="multipart/form-data">
      ...
      <table class="history masuk">
        ...
        ?>
          ...
          <tr class="data">
            ...
            <td class="kolomhistory5"><?= $keterangan; ?></td>
            <td class="kolomhistory6"><a href="edit_masuk.php?id=<?= $d['id_masuk']; ?>" class="tombol editdata">EDIT</a>
