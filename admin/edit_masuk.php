...
<body>
  ...
  <div class="container">
    ...
    $data = mysqli_query($koneksidb, "select * from masuk where id_masuk='$id'");
    while ($d = mysqli_fetch_array($data)) {

    ?>

      <div class="tambah">
        <h3>Form Ubah Bahan Baku (Masuk)</h3>
        <form action="edit_masuk_aksi.php?id=<?= $id; ?>" method="post">
          <table class="tambahdata">
            ...
            <tr>
              ...
              <td class="isiandata">
                <input type="text" name="supplier" value="<?= $d['supplier']; ?>" required>
              </td>
            </tr>
            <tr>
              <td class="labeldata">Keterangan</td>
              <td class="isiandata">
                <textarea rows="5" name="keterangan" value="<?= $d['keterangan']; ?>" required>
                    </textarea>
              </td>
            </tr>
            <tr>
              ...
              <td class="isiandata">
                <input type="hidden" name="jml_lama" value="<?= $d['jml_tambah']; ?>">
                <input type="text" name="jml_tambah" value="<?= $d['jml_tambah']; ?>" required>
              </td>
            </tr>
            <tr>
    ...
    <div class="data">
      ...
      <table class="history masuk">
        ...
        <?php
        $data = mysqli_query($koneksidb, "SELECT * FROM masuk");
        while ($d = mysqli_fetch_array($data)) {
          $tanggal = $d['tanggal'];
          $supplier = $d['supplier'];
        ...
        ?>
          ...
          <tr class="data">
            ...
            <td class="kolomhistory7">
              ...
              <a href="hapusmasuk.php?id=<?= $d['id_masuk']; ?>" class="tombol hapusdata" onclick="return confirm('APAKAH ANDA YAKIN INGIN MENGHAPUS DATA INI?')">HAPUS</a>
            </td>
          </tr>
