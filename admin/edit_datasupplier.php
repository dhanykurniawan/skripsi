...
<body>
    ...
    $data = mysqli_query($koneksidb, "select * from supplier where id_user='$id'");
    while ($d = mysqli_fetch_array($data)) {

    ?>

        <div class="tambah">
            <h3>Form Ubah Data Supplier</h3>
            <form action="editdata_supplier_aksi.php" method="post">
              <table class="tambahdata">
                <tr>
                  <td class="labeldata">Nama Supplier</td>
                  <td class="isiandata">
                    <input type="hidden" name="id" value="<?= $d['id_user']; ?>" >
                    <input type="text" name="nama_supplier" value="<?= $d['nama_supplier']; ?>">
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="isiandata">
                    <input type="password" name="password" class="isian-pass" value="<?= $d['password']; ?>">
